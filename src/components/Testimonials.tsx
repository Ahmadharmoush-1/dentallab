...
const testimonials = [
  {
    name: "Sarah M.",
    rating: 5,
    text: "Nahas Dental transformed my smile beyond my expectations. The team was professional, caring, and the results are stunning. I finally have the confidence to smile freely!",
